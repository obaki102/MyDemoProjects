...
namespace MyDemoProjects.Server.Application.Features.AnimeList.Commands
{
    public record GetToken() : IRequest<ServerResponse<TokenResponse>>;

     public class GetTokenhandler : IRequestHandler<GetToken, ServerResponse<TokenResponse>>
    {
        ...
        public async Task<ServerResponse<TokenResponse>> Handle(GetToken request, CancellationToken cancellationToken)
        {
